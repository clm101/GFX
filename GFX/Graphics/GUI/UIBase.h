...
public:
	...
	virtual bool contains_cursor(const Pos&) const noexcept { return true; }
	...
	struct UIResize {
		bool bInResizeRegion;
		std::optional<ResizeDirection> oResizeDirection = {};
		UIResize(bool b, std::optional<ResizeDirection> o = {}) : bInResizeRegion(b), oResizeDirection(o) {}
	};
	virtual void cursor_in_resize_region(const Pos& pos, std::vector<UIResize>& v) const noexcept;
};
